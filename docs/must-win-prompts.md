...
These are the five prompts ENVERA is engineered to answer with evidence that a free LLM cannot produce. Each prompt has an expected tool call, expected evidence fields, and the specific failure mode it guards against.
