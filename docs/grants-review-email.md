...
**Subject:** ENVERA — grant review request (Tier S, cross-agency financial enforcement intelligence)

Hi grants team,

ENVERA is live on the Context marketplace and ready for Tier S review.

**Tool name:** ENVERA — Cross-Agency Financial Regulatory Enforcement Intelligence
**Endpoint URL:** https://envera-production.up.railway.app/mcp
...
9. **Coverage audit / transparency** — *"How current is ENVERA's data per regulator, and which agencies are partial?"* → `get_agency_coverage`
